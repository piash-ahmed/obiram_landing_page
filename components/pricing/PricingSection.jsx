...
export default function PricingSection() {
  ...
  <button
    ...
    className={`py-[10px] px-[20px] font-medium transition-colors duration-300
      ${billing === "monthly" ? "monthly-btn" : "bg-transparent border border-transparent rounded-xl hover:border-orange-100"}`}
  >
    Monthly
  </button>
    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className={`py-[12px] px-[20px]  font-medium transition-colors duration-300
          ${billing === "annually" ? "monthly-btn" : "bg-transparent border border-transparent rounded-xl hover:border-orange-100"}`}
      >
        Annually{" "}
      </button>
