...
export default function WhyObiram() {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-between gap-3 w-11/12 mx-auto">
      <div className="flex flex-col mt-24 md:mt-32 lg:mt-40 py-3 flex-1">
        <div className="bg-[#f7f9fb] border border-[#d1d5db] rounded-full flex items-center gap-1 w-36 py-1 px-3 mb-4">
          ...
          />
          <p className="text-[12px] lg:text-[14px] text-[#373A46]">Why Obiram</p>
        </div>
        <div>
          ...
          <p className="text-[#373A46] text-[14px] md:text-[18px] font-light  md:w-9/12 lg:w-11/12 my-4 md:pr-5 opacity-[0.8] leading-[140%] mt-4 mb-6">
      ...
      <div className="  flex-1 bg-[#ffe2e2] rounded-xl relative top-20">
        ...
        >
           <div className="flex items-center gap-3 md:gap-5 rounded[17px] bg-white py-2 px-4 md:p-4 rounded-s-2xl">
            <div className="why-obiram-icon rounded-lg md:rounded-xl">
              <Image
                src="/icons/store-time-icon.png"
                alt="product icon"
                width={67}
                height={67}
                className="w-[47px] md:w-[67px] p-[5px] md:p-3"
              />
            ...
            <div className="w-11/12">
              ...
              <p className="text-[#C2C2C2] text-[12px] md:text-[14px] leading-[140%] font-light">
                From marketing tools to analytics and automation, Obiram helps you scale your business, not just start it.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3 md:gap-5 rounded[17px] bg-white py-2 px-4 md:p-4 rounded-s-2xl">
