...
export default function Hero() {
  return (
    <section className="text-white pt-16 pb-4 px-4 md:px-8 flex flex-col items-start w-11/12 mx-auto gap-6 items-center text-center">
        ...
        <div className="">
            <h1 className="text-[38px] lg:text-[60px] leading-[120%] tracking-[-1.2px]">
                Build, Run & Grow Your 
              <span className="font-instrument leading-[100%] tracking-[-2px] italic ml-3">Online Store.</span>
            </h1>
            <h1 className="text-[38px] lg:text-[60px] leading-[120%] tracking-[-1.2px]">The All-in-One Commerce Platform</h1>
